<template>
    <PageComponent title="Dashboard">
        ...
        <div v-else
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700 animate__animated animate__fadeInDown">
            ...
            <div class="bg-white shadow-md p-4 row-span-2 order-3 lg:order-1">
                ...
                <div class="flex justify-between text-sm mb-1">
                    <div>Expire Date:</div>
                    <div>{{ data.latestSurvey.expire_date ? data.latestSurvey.expire_date : 'No Expiration' }}</div>
                </div>
                <div class="flex justify-between text-sm mb-1">
                    <div>Status:</div>
